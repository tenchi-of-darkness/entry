...
export const ProudCat = (props: SvgProps) => {
    ...
    return (
        <Svg
            ...
            {...props}
        >
            <G id="TiredCat1" transform="matrix(.59221 0 0 2.79131 -75.4 -1009.415)">
                <Path
                    fill={Colors[colorScheme].cats.proud}
                    ...
                    transform="matrix(2.22392 0 0 .47183 -198.387 -55.23)"
                />
                ...
                <Path
                    ...
                    strokeWidth={0.89}
                    d="M551.191 926.704h11.786M584.677 926.544h11.786"
                    transform="matrix(2.22392 0 0 .47183 -1039.097 -55.098)"
                />
                ...
                <G id="Mouth">
                    <Path
                        ...
                        transform="matrix(2.22392 0 0 .47183 -197.855 -55.305)"
                    />
                </G>
                ...
                <Path
                    ...
                    transform="matrix(2.22392 0 0 .47183 -197.855 -55.918)"
                />
                ...
                <G id="Whiskers-Right">
                    <Path
                        ...
                        transform="matrix(2.22392 0 0 .47183 -196.292 -54.122)"
                    />
                </G>
                ...
                <G id="Whiskers-Left">
                    <Path
                        ...
                        strokeWidth={0.89}
                        d="M205.476 943.062c8.038 1.655 25.812 6.367 33.051 6.69M205.476 939.549c7.441-1.26 33.051-.991 33.051-.991M205.476 941.352c8.038-.032 25.812 2.504 33.051 3.138"
                        transform="matrix(-2.22392 0 0 .47183 667.072 -54.122)"
                    />
                </G>
            </G>
        </Svg>
