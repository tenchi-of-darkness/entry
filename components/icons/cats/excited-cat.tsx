...
export const ExcitedCat = (props: SvgProps) => {
    ...
    return (
        ...
        >
            <G
                id="EnergeticCat"
                transform="matrix(.59165 0 0 2.78866 -192.828 -1162.624)"
            >
                <Path
                    fill={Colors[colorScheme].cats.excited}
                ...
                <G id="Mouth">
                    ...
                    <Path
                        ...
                        stroke={Colors[colorScheme].cats.insideBorders}
                        strokeWidth={0.89}
                        d="M377.577 954.475c-.586.48 4.273 6.432 7.614 6.453 3.095.02 8.331-5.719 7.989-6.257"
                        transform="matrix(2.22392 0 0 .47183 -422.705 0)"
                    />
                </G>
                ...
                <G id="Whiskers-Right">
                    <Path
                        ...
                        transform="matrix(2.22392 0 0 .47183 2.5 1.245)"
                    />
                </G>
                ...
                <G id="Whiskers-Left">
                    <Path
                        ...
                        strokeWidth={0.89}
                        d="M205.476 943.062c8.038 1.655 25.812 6.367 33.051 6.69M205.476 939.549c7.441-1.26 33.051-.991 33.051-.991M205.476 941.352c8.038-.032 25.812 2.504 33.051 3.138"
                        transform="matrix(-2.22392 0 0 .47183 865.677 1.245)"
                    />
                </G>
            </G>
        </Svg>
