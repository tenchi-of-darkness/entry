...
export const OkayCat = (props: SvgProps) => {
    ...
    return (
        <Svg
            ...
            {...props}
        >
            <G id="OkayCat" transform="matrix(.59143 0 0 2.78764 -192.773 -1162.172)">
                <Path
                    fill={Colors[colorScheme].cats.okay}
