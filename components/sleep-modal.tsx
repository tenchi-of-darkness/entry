...
import {Dimensions, FlatList, Modal, Pressable, StyleSheet, Text, useWindowDimensions, View} from 'react-native';
...
const hoursOptions = Array.from({length: 25}, (_, i) => i * 0.5); // 0 to 12 hours
...
export function useSleepModal() {
    const [state, setState] = useState<SleepModalState>({visible: false, dayOfMonth: 1});
...
export function SleepModal(props: SleepModalProps) {
    ...
    const [activeIndex, setActiveIndex] = useState(16); // Default to 8 hours
        ...
        >
            ...
            <View style={styles.modalContainer}>
                ...
                <Pressable
                    ...
                    onPress={() => {
                        props.setDayOfMonthHours(props.state.dayOfMonth, hoursOptions[activeIndex]);
